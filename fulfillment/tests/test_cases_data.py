class TestCasesData:
    ...
    order_intent_drink_size_customize_training_phrases = [
        ...
        "{size} {drink} with {customize} and 2 sugars",
        "Hey. I need to order a {drink} of {size} size with {customize} from Starbucks.",
        "one double shot {size} {drink} with {customize} for pickup.",
        "I'd like a {size} {drink} with a splash of {customize}.",
        "I would like a {size} {drink} with {customize}, please.",
        "I want a {size} black decaffeinated {drink} with {customize}",
        "Can I get a {size} {drink} with {customize}?",
        "a {size} {drink} with {customize}.",
        "I'm looking for a {size} {drink} please with {customize}.",
        "I would like one {drink}, {size} with {customize}.",
        "I would like a {drink} with {customize}, a {size} size.",
        "{size} {drink} with {customize} and hot.",
        "Please order a {size} {drink} with {customize}.",
        "I like a {size} {drink} with {customize}.",
        "I'm going to do a {size} {drink} with {customize}.",
        "I need a {drink}, size {size} with {customize}.",
        "I'd like to order a {size} {drink} with a pop of {customize}, please.",
        "Can I get a {size} {drink} with {customize}?",
        "a {size} {drink}, with {customize}?",
        "a {drink} {size} with {customize}.",
        "one {size} {drink} with {customize} and not sweeteners.",
        "I'd like to order an {drink}, {size}, {customize}. That's it.",
        "I wanted just a {size} {customize} {drink}.",
        "Can I get a {size} {drink} with a sprinkle of {customize} in it.",
        "All right, I want to get a {size} {drink} with {customize}.",
        "Going to order a {size} {drink} with {customize}.",
        "looking for a {size} drink with {customize}.",
        "a {size} {drink}, with {customize} and extra hot.",
        "{size} {drink} {customize}.",
        "I would like to order a {size} {drink} with {customize}, please.",
        "Could I get a {size} {drink} with {customize}?",
        "I need a {customize} {drink}. {size}, please.",
        "I'd like a {size} {drink} with {customize}, please.",
        "A {size} {drink} please, with {customize}.",
        "I want a {size} {drink} with {customize}.",
        "Hey, I need a Starbucks {drink} {size} with {customize}.",
        "Yes, I need a {size} {drink} with a side of {customize}, please.",
        "{drink} with {customize} and {size} size.",
        "I'd like to order a {size} {drink} with a splash of {customize}.",
        "Hi, I need to get a {drink}, a {size} with {customize}, please.",
        "I'll like to order a {size} {drink} with {customize}.",
        "I want to get a {size} {drink} made with {customize}, please.",
        "Yeah. I'd like to get a {size} {drink} with {customize}, please.",
        "May I get a {size} {drink} with {customize}?",
        "I want {size} {drink} with {customize}.",
